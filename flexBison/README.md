...
For file like veriloga or c, there is a include statement that need to
read another file in that point, we can use the following scheme to
read the cotain of include file.
```
%{
#include <math.h>
#include <vector>
